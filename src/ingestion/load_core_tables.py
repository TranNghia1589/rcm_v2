...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--postgres_config", default=str(BASE_DIR / "configs" / "db" / "postgres.yaml"))
    parser.add_argument("--jobs_parquet", default=str(BASE_DIR / "artifacts" / "matching" / "jobs_matching_ready_v3.parquet"))
    parser.add_argument("--job_skill_map", default=str(BASE_DIR / "artifacts" / "matching" / "job_skill_map_v3.parquet"))
    parser.add_argument(
        "--cv_dataset",
