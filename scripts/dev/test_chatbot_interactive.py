...
Run:
python scripts/dev/test_chatbot_interactive.py
"""
...
def batch_test() -> None:
    ...
    extract_cmd = [
        "python", "src/cv/extract_cv_info.py", "--cv_path", str(cv_file), "--output_path", str(extracted_file)
    ]
    gap_cmd = [
